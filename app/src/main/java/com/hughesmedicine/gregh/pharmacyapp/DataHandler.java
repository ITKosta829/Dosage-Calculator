...
public class DataHandler {
    ...
    public boolean TOS;
    public String id, gender, functionToggle, heightUnit, weightUnit, displayHeight, displayWeight, displayIdealWeight, displayCrCl;
...
//    }
    ...
    private void emailScreenshot (File imageFile) {
        String emailSubject = "Vancomycin Dosing Calculator Screenshot";
    ...
    public Double setDoseSpinnerWeight(){
        Double d = calcWeight * 15;
    ...
    private void setVd_L() {
        Vd_L = age * 0.17 + calcWeight * 0.22 + 15;
    ...
    private void setTimeToSteadyState() {
        ...
        if (functionToggle.equals("getValues")){
            setInfusionTime();
